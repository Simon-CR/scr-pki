...
### Fixed
- **Nginx Healthcheck**: Updated Nginx healthcheck to use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.

## [0.2.13] - 2025-12-10

### Fixed
- **Backend Healthcheck**: Added `curl` to the backend Docker image to ensure healthchecks pass correctly.

## [0.2.12] - 2025-12-09

### Added
- **Public Root CA Download**: Added a "Download Root CA" button to the login page to allow easy onboarding of new devices without authentication.
